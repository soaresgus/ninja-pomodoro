...
interface PopoverProps extends React.ComponentProps<typeof Popover.Root> {
    title?: string,
    icon: any,
...
export function PopoverButton({ title, icon, children, paleteColor, avoidCollisions = true, ...props }: PopoverProps) {
